...
After you are familiar with the main elements of the plugins, section
:ref:`plugin_template_description` describes in detail the structure of the cookiecutter
plugin template.
